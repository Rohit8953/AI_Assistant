...
const Testimonial = () => {
        ...
        <div className="p-4 rounded-lg mx-2 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-slate-500 text-start">{card.handle}</span>
                </div>
            </div>
            <p className="text-sm py-4 text-gray-700 text-start font-semibold ">{card.title}</p>
            <p className="text-sm py-4 text-gray-800 text-start -mt-6">{card.content}</p>
    ...
    return (
        ...
        `}</style>
           <div className="px-4 sm:px-20 x1:px-32 my-14">
            <div className="text-center">
              <h2 className="text-slate-700 text-[42px] font-semibold">
                People's Reviews
              </h2>
              <p className="text-gray-50@ max-w-lg mx-auto">
